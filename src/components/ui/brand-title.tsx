...
export const BrandTitle = ({ className, showGuns = false, ...props }: Props) => {
  return (
    <div className="relative mt-16 w-full">
      ...
      {showGuns && (
        <Fragment>
          <GunIcon className="pointer-events-none absolute top-8 left-10 select-none" size={268} />
          <GunIcon
            className="pointer-events-none absolute top-8 right-10 scale-x-[-1] select-none"
            size={268}
          />
        </Fragment>
      )}
